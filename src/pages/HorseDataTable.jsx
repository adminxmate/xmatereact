      ...
      <div className="min-h-screen bg-[#333538] text-white p-4 md:p-10 font-sans">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-3 mb-6 bg-black/20 p-4 rounded border border-gray-800">
            <input
              className="bg-[#111] border border-gray-700 p-2 rounded text-sm outline-none focus:border-[#e23e44]"
            ...
            <input
              className="bg-[#111] border border-gray-700 p-2 rounded text-sm outline-none focus:border-[#e23e44]"
              placeholder="Filter Sire..."
              value={filters.sire}
              onChange={(e) => setFilters({ ...filters, sire: e.target.value })}
            />
            <input
              className="bg-[#111] border border-gray-700 p-2 rounded text-sm outline-none focus:border-[#e23e44]"
              placeholder="Filter Dam..."
              value={filters.dam}
            ...
            <input
              ...
              onChange={(e) => setFilters({ ...filters, damsire: e.target.value })}
            />
                  ...
                  {loading ? (
                    <tr>
                      <td colSpan="5" className="p-20 text-center">
                        <Loader2 className="animate-spin mx-auto text-[#e23e44]" />
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td colSpan="5" className="p-16 text-center text-gray-600 italic">
                        No horses found. Try adjusting your filters.
                      </td>
                    </tr>
                  )}
                </tbody>
